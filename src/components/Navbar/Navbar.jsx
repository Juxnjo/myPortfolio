...
export const NavBar = () =>
{
    ...
    const content = <>
        <div className='lg:hidden block absolute mt-12 w-full left-0 right-0 bg-primaryLight transition italic '>
            <ul className='text-center text-xl p-20'>
                ...
                <a href="mailto:juxnjo.dev@gmail.com">
    ...
    return (
        <nav className="pt-5 pb-5 font-SourceCodePro">
                ...
                <div className='lg:flex md:flex lg:flex-1 items-center justify-end font-normal hidden'>
                    <div className='flex-10'>
                        <ul className='flex gap-8 mr-16 text-[18px]'>
                            ...
                            <a href="mailto:juxnjo.dev@gmail.com" className="">
                                <li className=' text-blue-500 transition border-b-2 border-slate-900 hover:border-blue-500 cursor-pointer  '> Contact Me</li>
                            </a>
                        </ul>
                    </div>
                </div>
